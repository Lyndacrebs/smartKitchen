...
export default function App() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `
    Crie uma receita utilizando os ingredientes: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4} para um ${ocasiao}.
    
    IMPORTANTE: 
    - Primeiro escreva apenas o título da receita (apenas o nome dela, sem explicações), depois dê uma quebra de linha (\n).
    - Em seguida, escreva a receita completa detalhada, com os passos.
